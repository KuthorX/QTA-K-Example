...
def request_get(url, headers=None, proxies=None, if_print_curl_str=True):
    """
    GET request
    :param url:
    :param headers:
...
def request_post(url, headers=None, post_data=None, proxies=None, if_print_curl_str=True):
    """
    POST request
    :param url:
    :param headers:
